...
class CustomerPlannedList extends StatefulWidget {
  final Map param;
  CustomerPlannedList({this.param});
  @override
  _CustomerPlannedListState createState() => _CustomerPlannedListState();
}

class _CustomerPlannedListState extends State<CustomerPlannedList> {
  ...
  Future defaultSetting() async {
    ...
    prefs.setString("currentActivity", UavRoutes.CustomerPlannedList);
    authService.checkAuthenticity(context);

    getCustomerPlannedList();
  }

  Future getCustomerPlannedList() async {
